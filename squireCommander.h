/* 
 * File:   SquireCommander.h
 * Author: applet
 *
 * Created on January 28, 2015, 12:43 PM
 */

#ifndef SQUIRECOMMANDER_H
#define	SQUIRECOMMANDER_H
...
// CONFIG1H
#pragma config FOSC = ECHP  // Oscillator Selection bits (Internal oscillator block)
